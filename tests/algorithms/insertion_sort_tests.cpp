...
TEST_CASE("insertion_sort sorts an unsorted vector") {
...
TEST_CASE("insertion_sort keeps an already sorted vector unchanged") {
...
TEST_CASE("insertion_sort sorts a reverse-sorted vector") {
...
TEST_CASE("insertion_sort works with duplicate values") {
...
TEST_CASE("insertion_sort works with negative values") {
...
TEST_CASE("insertion_sort works with an empty vector") {
...
TEST_CASE("insertion_sort works with a single-element vector") {
...
TEST_CASE("insertion_sort produces sorted output for a larger mixed vector") {
