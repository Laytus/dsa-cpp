...
- [x] **Binary Search** — Classic implementation + variants (lower bound, upper bound)
- [x] **Two Pointers** — Fundamental pattern for arrays and strings
- [x] **Sliding Window** — Fixed window and variable window
- [x] **Prefix Sum** — Technique for range queries in O(1)
- [x] **Stack Patterns** — Monotonic stack, next greater element
